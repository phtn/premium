...
// export type IsSecretKey<Key extends SecretOrPublicKey> = Key extends SecretKey
//   ? true
//   : false;
// export type IsPublicKey<Key extends SecretOrPublicKey> = Key extends PublicKey
//   ? true
//   : false;

// export type MetadataType = Record<string, any> | undefined;

// export type AllowedPaymentMethods = "card" | "paymaya";
